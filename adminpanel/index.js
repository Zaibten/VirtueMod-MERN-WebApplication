...
app.get('/', (req, res) => {
  res.send(`
    ...
    <head>
      ...
      <title>Virtue Admin Panel</title>
...
<head>
    ...
    <link rel="icon" href="assets/logo.png">
    <title>Virtue Mod Admin Dashboard - This is an example dashboard created using built-in elements and components.</title>
    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
        <div class="app-header header-shadow">
            <div class="app-header__logo">
                <div class="script-font">Virtue Mod</div>
...
<li>
    ...
    <i class="fas fa-user-shield icon-gradient bg-mean-fruit"></i>
                                    ...
                                    <div>Virtue Mod Admin Dashboard
                                        <div class="page-title-subheading">Virtue Mod is a next-generation AI image generation platform built with a modern full-stack architecture.
                                        </div>
                                    </div>
                                </div>
...
<div class="row">
        ...
        <div class="card mb-3 widget-content bg-midnight-bloom">
            <div class="widget-content-wrapper text-white">
                <div class="widget-content-left">
                    ...
                    <div class="widget-subheading">Virtue Mod Users</div>
                </div>
    ...
    <div class="col-md-6 col-xl-4">
        <div class="card mb-3 widget-content bg-grow-early">
            <div class="widget-content-wrapper text-white">
                <div class="widget-content-left">
                    <div class="widget-heading">Virtue Mod Versions</div>
                    <div class="widget-subheading">Total Users Of Virtue Mod Versions</div>
                </div>
                <div class="widget-content-right">
...
<style>
    ...
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            <div class="card-header">Virtue Mod Daily Active Users
  ...
  <div class="col-md-12 col-lg-6">
    <div class="mb-3 custom-card">
      <div class="custom-card-header">
        ...
        <div class="custom-card-header-title">Virtue Mod User Statistics</div>
      </div>
  ...
  <div class="col-md-12 col-lg-6">
    <div class="mb-3 custom-card">
      <div class="custom-card-header">
        ...
        <div class="custom-card-header-title">Virtue Mod Engagement Comparison</div>
      </div>
      <div class="custom-card-body">
                                    ...
                                    <ul class="nav">
                                        <li class="nav-item">
                                            <a href="javascript:void(0);" class="nav-link">
                                                Virtue Mod Private Limited
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="javascript:void(0);" class="nav-link">
                                                Developed By Virtue Mod
                                            </a>
                                        </li>
                                    </ul>
                                </div>
